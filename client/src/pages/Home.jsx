  ...
  return (
    <div>
      ...
      <div className='flex flex-row gap-6 p-28 px-3 max-w-6xl mx-auto'>
        <div  >
        <h1 className='text-slate-700 font-bold text-3xl lg:text-6xl py-5'>
          Find your next <span className='text-slate-500'>perfect</span>
          <br />
          place with ease
        </h1>
        <div className='text-gray-400 text-xs sm:text-sm py-5'>
          Premier Estate is the best place to find your next perfect place to
          live.
          <br />
        ...
        <img src= 'Logo4.png' className="max-w-s" />
        </div>
      </div>
